     ...
     <div className="section__wrapper header__container">
      <div className="column intro__container blur__effect">
        ...
        <div className="header__info__middle">
          ...
          <p className="text__muted header__description">I solve intricate user experience challenges by designing thoughtful, integrity-driven solutions that create meaningful impact.</p>
        </div>
        <Facts/>
        <div className="header__info__bottom">
          {/* <button className='btn'>Download CV</button> */}
          <a href="mailto:hapenciuccatalin@yahoo.com" className='btn'>Email Me</a>
        </div>
      </div>
